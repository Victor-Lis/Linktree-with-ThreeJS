...
function move({ direction }) {
    if (direction == 1) (0, _scenePhysJs.sphere).body.angularVelocity.set(10, 0, 0);
    else if (direction == 2) (0, _scenePhysJs.sphere).body.angularVelocity.set(-10, 0, 0);
    else if (direction == 3) (0, _scenePhysJs.sphere).body.angularVelocity.set(0, 0, 10);
    else (0, _scenePhysJs.sphere).body.angularVelocity.set(0, 0, -10);
}
...
parcelHelpers.export(exports, "sphere", ()=>sphere);
parcelHelpers.export(exports, "renderScenePhys", ()=>renderScenePhys);
var _three = require("three");
var _cannonEs = require("cannon-es");
var _datGui = require("dat.gui");
var _orbitControlsJs = require("three/examples/jsm/controls/OrbitControls.js");
...
const roofSphereContactMat = new _cannonEs.ContactMaterial(roof.physMat, (0, _scenePhysJs.sphere).phys, {
    friction: 0.5
});
roof.body.quaternion.setFromEuler(Math.PI / 2, 0, 0);
(0, _scenePhys.world).addContactMaterial(roofSphereContactMat);
